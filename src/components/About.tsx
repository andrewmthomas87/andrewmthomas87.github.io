		...
		<section className={s.about}>
			...
			<div className={s.block}>
				...
				<div className={s.text}>
					<div className={s.paragraph}>Hi! My name is Andrew Thomas. I'm a college student, developer, and entrepreneur. I grew up in Longmont, Colorado. Now I attend Northwestern University in Evanston, Illinois, and study Computer Science and engineering.</div>
					<div className={s.paragraph}>I've been writing code and working with robots for a while now and I love it. I've worked for a couple tech startups where I've developed several applications from the ground up. With company growth, I've spent significant time integrating new developers, which has sparked my interest in mentoring. I mentor a competetive high school robotics team and lead a tech-focused student group.</div>
					<div className={s.paragraph}>When I get the chance, I snowboard, play hockey, cruise around on my electric skateboard, or drive about soaking in Colorado's beauty.</div>
				</div>
			</div>
		</section>
	)
