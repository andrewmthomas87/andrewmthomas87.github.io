...
`,w=se.split(`
`).filter(o=>!!o).map(o=>{const a=o.split(": ");return{title:a[0],values:a[1].split(", ")}}),T=Math.ceil(w.length/2),L=w.slice(0,T),P=w.slice(T),ce=()=>{const o=g();return i(t,{bgcolor:o.palette.primary.main,children:[e(c,{variant:"h1",component:"h2",pt:3,fontFamily:"'Bebas Neue', cursive",textAlign:"center",children:"My Skills"}),i(t,{px:1,pt:2,pb:3,fontFamily:"'Fira Code', monospace",textAlign:"center",children:["Computer Science is no more about computers than astronomy is about telescopes"," ",e("span",{style:{opacity:.75},children:"// Edsger W. Dijkstra"})]}),e(t,{width:1,overflow:"auto",children:e(l,{direction:"row",children:i(t,{display:"flex",flexDirection:"column",width:"fit-content",px:3,pb:4,bgcolor:o.palette.primary.dark,children:[e(l,{direction:"row",spacing:3,p:3,pb:1,children:L.map(a=>e(t,{width:"15em",children:e(c,{variant:"h6",fontFamily:"'Fira Code', monospace",children:e(t,{component:"span",pb:1,borderBottom:`1px solid ${o.palette.primary.light}`,children:a.title})})}))}),e(l,{direction:"row",spacing:3,p:3,children:L.map(a=>e(t,{width:"15em",children:a.values.map((d,n)=>e(t,{display:"inline-block",pr:1,pb:1,children:e(v,{label:d})},n))}))}),e(t,{py:1,children:e(Q,{})}),e(l,{direction:"row",spacing:3,p:3,pb:1,children:P.map(a=>e(t,{width:"15em",children:e(c,{variant:"h6",fontFamily:"'Fira Code', monospace",children:e(t,{component:"span",pb:1,borderBottom:`1px solid ${o.palette.primary.light}`,children:a.title})})}))}),e(l,{direction:"row",spacing:3,p:3,children:P.map(a=>e(t,{width:"15em",children:a.values.map((d,n)=>e(t,{display:"inline-block",pr:1,pb:1,children:e(v,{label:d})},n))}))})]})})})]})};var le="/assets/andrew.8d74b5e9.jpg";const de=()=>i(t,{height:"100vh",display:"flex",flexDirection:"column",alignItems:"stretch",children:[e(t,{visibility:"hidden",children:e(x,{position:"static",children:e(C,{variant:"dense"})})}),e(t,{flex:1,position:"relative",sx:{backgroundImage:`url(${le})`,backgroundSize:"cover",backgroundPosition:"60% 57.5%"},children:i(c,{variant:"h1",color:"white",position:"absolute",bottom:"0.75em",left:"0.75em",fontFamily:"'Bebas Neue', cursive",fontSize:"8em",letterSpacing:"0",lineHeight:"0.875em",children:["Andrew",e("br",{}),"Thomas"]})})]}),pe=()=>{const o=H.exports.useMemo(()=>U({palette:{mode:"dark",primary:{main:"#303f9f"}}}),[]);return i(q,{theme:o,children:[e(V,{}),e(re,{}),e(de,{}),e(ee,{}),e(ce,{}),e(ne,{}),e(ie,{})]})};K.render(e(X.StrictMode,{children:e(pe,{})}),document.getElementById("root"));
